...
# MinIO config
minio_url = os.getenv('BUCKET_ENDPOINT', 'http://minio:9000')
minio_access_key = os.getenv('BUCKET_ACCESS_KEY_ID')
minio_secret_key = os.getenv('BUCKET_SECRET_ACCESS_KEY')
bucket_name = os.getenv('BUCKET_NAME', 'omnileads')
